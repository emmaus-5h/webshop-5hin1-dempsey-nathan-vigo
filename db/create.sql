...
insert into products (name, description, code, price) values ('Air Jordan 4', 'Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id.', '816905633-0', 10.5);
...
insert into reviews (auteur, opmerking, sneaker_id) values ('Josh', 'Harde patta', 1);